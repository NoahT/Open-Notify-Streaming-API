...
class SequentialEphemeralElectionFacade(ElectionFacade):
    ...
    """
    def __init__(self, zookeeper_client: KazooZookeeperClient, znode_path: str='/election'):
    ...
    def connect(self) -> None:
        znode = self._zookeeper_client.create(f'{self._znode_path}/znode_', sequential=True, ephemeral=True)
        self._znode = znode
    ...
    def check_leadership_status(self, leader_func: FunctionType) -> bool:
        ...
        znode_name = self._znode.removeprefix(self._znode_path)
        ...
        if znode_index == 0:
            ...
            # the preceding znode.
            znode_watch_path = f'{self._znode_path}/{znode_watch}'
    ...
    def _initialize_znode_election_path(self) -> None:
        self._zookeeper_client.create(self._znode_path, None)
    
    def _get_sorted_children(self) -> list:
        children = self._zookeeper_client.get_children(self._znode_path)
