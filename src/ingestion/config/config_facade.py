"""
  (This is code copied and modified from an older project
  https://github.com/NoahT/spotifind-flask-api/blob/main/src/api/config/config_facade.py.
  I've created an issue so that some of the generic code used can be
  published into packages.)
